...
Hacer un Algoritmo en JAVA bajo el enfoque POO que lea el nombre de 3 
estudiantes y sus dos notas parciales y determine quien aprueba o no la asignatura. 
...
public class POO {
    ...
    public static void main(String[] args) {
        ...
        //est.   // El objeto est me permite visualizar todos los elementos públicos como protected ya que la clase Estudiante esta dentro del mismo paquete
